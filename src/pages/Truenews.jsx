  ...
  return (
    <Box sx={{ width: '100%', backgroundColor: '#101225', color: 'white', py: 8, px: 2 }}>
      <Box sx={{ width: '100%', maxWidth: 'lg', mx: 'auto' }}>
        <Typography sx={{ color: '#45e98fff', fontSize: '2rem', fontWeight: 'bold', textAlign: 'center', mb: 4 }} data-aos="fade-up" data-aos-delay="200">
          ข่าวจริง
        </Typography>
        ...
        <Grid container justifyContent="center">
          <Button
            ...
            sx={{
              ...
              height: '2.8rem',
              mt: 2,
              backgroundImage: 'linear-gradient(to right, #2b8747ff, #2b8747ff)',
              color: 'white',
              boxShadow: 'none'
            }}
            data-aos="fade-up"
            data-aos-delay="500"
            onClick={() => navigate('/true-news-all')}
          >
            ดูข่าวจริงเพิ่มเติม
          </Button>
        </Grid>
